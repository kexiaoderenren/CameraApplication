...
public class Camera2BasicFragment extends Fragment implements View.OnClickListener {
    ...
    private static final int CAMERA_COMSSION_REQUEST_CODE = 66;
    ...
    private void captureStillPicture() {
        ...
        try {
            ...
            mCaptureSession.stopRepeating(); // 停止连续取景
    ...
    private void openCamera(int width, int height) {
        if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            requestPermissions(new String[]{Manifest.permission.CAMERA}, CAMERA_COMSSION_REQUEST_CODE);
            return;
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == CAMERA_COMSSION_REQUEST_CODE) {
